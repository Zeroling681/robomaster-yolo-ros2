...
| `experiment_one_v13_jetson_ros2_kit.zip` | final PT model, Jetson detector, ROS 2 package, capture helper and quick-start guide | `5bc300b6020ddd7af77bef68a929f417c4e598cd36a10af5c813d685e21f6be3` |

The audited v13 dataset is stored directly under
`dataset_work/audit_dataset_v13/`. The final English report is available in
both DOCX and PDF form under `docs/`.

Use `JETSON_ROS2_QUICKSTART.md` with the third archive to collect the one live
Jetson topic record that cannot be produced while the physical board is
disconnected.
