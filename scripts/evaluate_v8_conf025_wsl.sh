...
exec python /mnt/f/PycharmProjects/robomaster/scripts/evaluate_test_predictions.py \
  --dataset . \
  --model /mnt/f/PycharmProjects/robomaster/runs/detect/mouse_cup_yolo11n_v8_768/weights/best.pt \
  --output /mnt/f/PycharmProjects/robomaster/runs/detect/mouse_cup_yolo11n_v8_768_test_conf025 \
  --imgsz 768 \
  --conf 0.25 \
  --iou 0.45 \
  --device 0
